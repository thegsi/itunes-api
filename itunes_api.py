...
def getApps():
    ...
    def getRequest ():
        ...
        try:
            ...
            offsetUrl = 'https://itunes.apple.com/search?term=books&country=gb&entity=software&genreId=6018&offset=%d&limit=25' % offset
            ...
            if len(appcontent['results']) > 0 and offset < 2880:
